...
export default function Hero() {  
  return (
    <section className="py-6 md:py-12 px-4 md:px-6 bg-white dark:bg-black transition-colors duration-300">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between gap-4 md:gap-8">
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-1 md:mb-2 text-black dark:text-white transition-colors duration-300 leading-tight">
              Hi, I'm Varshith
            </h1>
            <p className="text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-400 transition-colors duration-300">
              aka VOLT
            </p>
          </div>
