...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  useEffect(() => {
    ...
    // Defer heavy Three.js initialization to unblock main thread
    const init = () => {
    ...
    if (mustReinit) {
      ...
      // High pixel ratio with heavy effects is a killer on performance.
      // Cap at 1.0 specifically for this effect as it is pixelated art anyway.
      ...
      const mapToPixels = (e: PointerEvent) => {
        // Cache rect to avoid layout thrashing on every frame
